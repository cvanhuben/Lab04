	...
	<body>
		...
		<div class="previews">
			<div name="cjPreview">
				<h2>CJ Van Huben</h2>
				<p>
					I was born in Poughkeepsie, NY on October 24th. I am the youngest of two children. My mom's name is Margaret and my dad's name is Gary. My sister's name is Anne. I attended Arlington High School and graduated in 2014.
				</p>
				<a href="pages/cj.php">...Read more about CJ...</a>
			</div>
			<div name="frankiePreview">
				<h2>Frankie Romero</h2>
				<p>
				...
				<a href="pages/frankieportfolio.php">...Read more about Frankie...</a>
			</div>
			<div name="jienPreview">
				<h2>Jien Ogawa</h2>
				<p>
				...
				<a href="pages/cj.php">...Read more about Jien...</a>
			</div>
		</div>
		<footer>
			<p>CJ - Frankie - Jien</p>	
